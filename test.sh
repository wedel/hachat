...
if echo $1 | egrep -q '^[0-9]+$'; then
    ...
    echo "We will wait for $1 minute(s) between starting first 3 and last 2 peers"
    echo "have fun chatting..."
else
    echo "need to get number as first argument for sleeping time between starting first 3 and last 2 peers"
    echo "exiting..."
    exit 0
fi
